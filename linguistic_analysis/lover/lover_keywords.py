...
I think he knows
Miss americana and the heartbreak price
...
wordcloud = WordCloud(width=800, height=800, background_color='white', colormap='spring', mask=circle_mask).generate_from_frequencies(word_freq)
